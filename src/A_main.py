...
EPISODES = 50_000  # max episodes to train for
...
STUDY = 'PPO_2022_07_25_study'  # SAC_2022_07_23_study PPO_2022_07_23_study
...
if MODE == 'Optimization':  # study
    ...
    study = optim.enqueue_defaults(study, agent, n_trials=0)
    ...
    model = 'PPO20220722-142740'  # name of the model to load
    tests = 3  # number of test episodes

    agent = PPO.load(Path(f'optimization\{model}\best_model'))  # fr'checkpoints\{model}')
